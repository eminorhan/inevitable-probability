...
if __name__ == '__main__':
    ...
    tr_cond               = 'all_gains'
    test_cond             = 'all_gains'
    generator             = BinaryCategorizationTaskFFWD(max_iter=150001, batch_size=10, n_in=n_in, n_out=1, sigma_sq=100.0, tr_cond=tr_cond)
...
#    lasagne.layers.set_all_param_values(l_rec,[npzfile_lout['arr_0'],npzfile_lout['arr_1'],npzfile_lout['arr_2'],npzfile_lout['arr_3'],npzfile_lout['arr_4']])
    ...
    # SAVE TRAINED MODEL  
    sio.savemat('bc_nin%i_nhu%i_jobidx%i.mat'%(n_in,n_hid,job_idx), {'inf_loss':inf_loss, 'inf_loss_vec':np.asarray(inf_loss_vec), 'success':success } )      