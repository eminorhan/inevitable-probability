...
if __name__ == '__main__':
    ...
    generator             = StimulusDemixingTaskFFWD(W_mix, f_I, f_b, max_iter=30001, batch_size=100, n_in=10, n_out=4, nmc = 250, tr_cond=tr_cond)
...
#    lasagne.layers.set_all_param_values(l_rec,[npzfile_lout['arr_0'],npzfile_lout['arr_1'],npzfile_lout['arr_2'],npzfile_lout['arr_3'],npzfile_lout['arr_4']])
    ...
    # SAVE TRAINED MODEL  
    sio.savemat('sd_testinfloss_twogains_run%i.mat'%job_idx, {'inf_loss_test':inf_loss_test, 'opt_vec':opt_vec, 'net_vec':net_vec})      
